...
let outerRadius = 400;
let linesToDraw = 0;
// let circleDisplayTime = 3000; // Time to display each circle except the last one (in milliseconds)
// let lastCircleDisplayTime = 5000; // Time to display the last circle (in milliseconds)
//
// let currentCircleIndex = 49;
...
function daytimeDraw() {
  ...
  for (let j = 0; j < dayTime.length; j++) {
    ...
    //     currentCircleIndex = 49; // Reset to display from the beginning
